...
import com.lsn.lib.ui.widget.alpha.XUIAlphaRelativeLayout;
...
public class XUIRelativeLayout extends XUIAlphaRelativeLayout implements IXUILayout {
    ...
    public XUIRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public XUIRelativeLayout(Context context, AttributeSet attrs, int defStyleAttr) {
