...
package com.lsn.lib.ui.widget.banner.recycler.layout;
...
public class BannerLayoutManager extends RecyclerView.LayoutManager {
    ...
    public int getCurrentPosition() {
        ...
        if (!mInfinite) {
            System.out.println("mCurrentIndex :2.5) " + mInfinite);
        ...
        int i = position == getItemCount() ? 0 : position;

        System.out.println("mCurrentIndex :3) " + i);
        return i;
