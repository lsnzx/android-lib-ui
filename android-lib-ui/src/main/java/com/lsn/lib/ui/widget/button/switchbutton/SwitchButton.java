package com.lsn.lib.ui.widget.button.switchbutton;
...
public class SwitchButton extends CompoundButton {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mTintColor == 0) {
            ...
            boolean found = context.getTheme().resolveAttribute(androidx.appcompat.R.attr.colorAccent, typedValue, true);
            if (found) {
