...
import com.lsn.lib.ui.widget.XUIKeyboardScrollView;
import com.lsn.lib.ui.widget.dialog.materialdialog.internal.MDAdapter;
...
import com.lsn.lib.ui.widget.progress.materialprogressbar.HorizontalProgressDrawable;
import com.lsn.lib.ui.widget.progress.materialprogressbar.IndeterminateCircularProgressDrawable;
import com.lsn.lib.ui.widget.progress.materialprogressbar.IndeterminateHorizontalProgressDrawable;
...
class DialogInit {
    ...
    public static void init(final MaterialDialog dialog) {
        ...
        if (builder.backgroundColor == 0) {
            builder.backgroundColor =
                    ThemeUtils.resolveColor(
                            ...
                            ThemeUtils.resolveColor(dialog.getContext(), androidx.appcompat.R.attr.colorBackgroundFloating));
        }
        if (builder.backgroundColor != 0) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            ...
            if (textAllCaps) {
                textAllCaps = ThemeUtils.resolveBoolean(builder.context, androidx.appcompat.R.attr.textAllCaps, true);
            }
        } else {
            textAllCaps = ThemeUtils.resolveBoolean(builder.context, androidx.appcompat.R.attr.textAllCaps, true);
        }
