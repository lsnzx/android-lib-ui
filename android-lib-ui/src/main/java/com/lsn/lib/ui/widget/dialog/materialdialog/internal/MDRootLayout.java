...
import com.lsn.lib.ui.widget.dialog.materialdialog.StackingBehavior;
...
public class MDRootLayout extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        buttonBarHeight = ThemeUtils.resolveDimension(context, R.attr.md_button_height, r.getDimensionPixelSize(R.dimen.default_md_button_height_phone));

        dividerPaint = new Paint();
        dividerWidth = r.getDimensionPixelSize(R.dimen.md_divider_height);
        dividerPaint.setColor(ThemeUtils.resolveColor(context, R.attr.md_divider_color));
