...
import com.lsn.lib.ui.utils.UIKeyboardUtils;
 ...
 */
public class XUIKeyboardScrollView extends ScrollView implements UIKeyboardUtils.SoftKeyboardToggleListener {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        if (mAutoScroll) {
            UIKeyboardUtils.addKeyboardToggleListener(this, this);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        if (mAutoScroll) {
            UIKeyboardUtils.removeKeyboardToggleListener(this);
        }
    ...
    protected void onScrollChanged(int l, int t, int oldl, int oldt) {
        ...
        if (mScrollHide) {
            UIKeyboardUtils.hideSoftInput(this);
        }
    }
