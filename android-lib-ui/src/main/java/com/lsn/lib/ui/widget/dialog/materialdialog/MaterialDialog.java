...
package com.lsn.lib.ui.widget.dialog.materialdialog;
...
import com.lsn.lib.ui.utils.ResUtils;
import com.lsn.lib.ui.utils.StatusBarUtils;
import com.lsn.lib.ui.utils.ThemeUtils;
import com.lsn.lib.ui.widget.dialog.DownLoadDialogListener;
import com.lsn.lib.ui.widget.dialog.materialdialog.internal.MDButton;
import com.lsn.lib.ui.widget.dialog.materialdialog.internal.MDRootLayout;
import com.lsn.lib.ui.widget.dialog.materialdialog.internal.MDTintHelper;
import com.lsn.lib.ui.widget.dialog.materialdialog.internal.ThemeSingleton;
import com.lsn.lib.ui.widget.dialog.materialdialog.util.RippleHelper;
...
public class MaterialDialog extends DialogBase
    ...
    final Drawable getListSelector() {
        ...
        return ThemeUtils.resolveDrawable(getContext(), R.attr.md_list_selector);
    }
    ...
    public void setIconAttribute(@AttrRes int attrId) {
        Drawable d = ThemeUtils.resolveDrawable(builder.context, attrId);
        setIcon(d);
    }
    ...
    public final void setProgress(final int progress, DownLoadDialogListener downLoadDialogListener) {
                    ...
                    public void run() {
                        ...
                        if (progressMinMax != null) {
                            if (downLoadDialogListener != null) {
                                downLoadDialogListener.onProcess(getCurrentProgress(), getMaxProgress());
                            }
                            float progressMB = getCurrentProgress() * 1f / 1024 / 1024;
                            float maxMB = getMaxProgress() * 1f / 1024 / 1024;
                            progressMinMax.setText(String.format("%.2f", progressMB) + "MB/" + String.format("%.2f", maxMB) + "MB");
                        }
                    }
                });
    }
    ...
    public final void setProgressPercentFormat(NumberFormat format) {
        builder.progressPercentFormat = format;
        setProgress(getCurrentProgress(), null); // invalidates display
    }
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            final int materialBlue = ThemeUtils.getColor(context, R.color.md_material_blue_600);

            // Retrieve default accent colors, which are used on the action buttons and progress bars
            this.widgetColor = ThemeUtils.resolveColor(context, androidx.appcompat.R.attr.colorAccent, materialBlue);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                this.widgetColor = ThemeUtils.resolveColor(context, android.R.attr.colorAccent, this.widgetColor);
            }

            this.positiveColor = ThemeUtils.getActionTextStateList(context, this.widgetColor);
            ...
            this.linkColor =
                    ThemeUtils.getActionTextStateList(
                            context, ThemeUtils.resolveColor(context, R.attr.md_link_color, this.widgetColor));

            int fallback = 0;
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                fallback = ThemeUtils.resolveColor(context, android.R.attr.colorControlHighlight);
            }
            this.buttonRippleColor =
                    ThemeUtils.resolveColor(
                            context,
                            R.attr.md_btn_ripple_color,
                            ThemeUtils.resolveColor(context, androidx.appcompat.R.attr.colorControlHighlight, fallback));
            ...
            this.theme = ThemeUtils.isColorDark(primaryTextColor) ? Theme.LIGHT : Theme.DARK;
            ...
            this.titleGravity =
                    ThemeUtils.resolveGravityEnum(context, R.attr.md_title_gravity, this.titleGravity);
            this.contentGravity =
                    ThemeUtils.resolveGravityEnum(context, R.attr.md_content_gravity, this.contentGravity);
            this.btnStackedGravity =
                    ThemeUtils.resolveGravityEnum(
                            context, R.attr.md_btnstacked_gravity, this.btnStackedGravity);
            this.itemsGravity =
                    ThemeUtils.resolveGravityEnum(context, R.attr.md_items_gravity, this.itemsGravity);
            this.buttonsGravity =
        ...
        public Builder buttonRippleColorRes(@ColorRes int colorRes) {
            return buttonRippleColor(ThemeUtils.getColor(this.context, colorRes));
        }

        public Builder buttonRippleColorAttr(@AttrRes int colorAttr) {
            return buttonRippleColor(ThemeUtils.resolveColor(this.context, colorAttr));
        }
        ...
        public Builder titleColorRes(@ColorRes int colorRes) {
            return titleColor(ThemeUtils.getColor(this.context, colorRes));
        }

        public Builder titleColorAttr(@AttrRes int colorAttr) {
            return titleColor(ThemeUtils.resolveColor(this.context, colorAttr));
        }
        ...
        public Builder iconAttr(@AttrRes int iconAttr) {
            this.icon = ThemeUtils.resolveDrawable(context, iconAttr);
            return this;
        }
        ...
        public Builder contentColorRes(@ColorRes int colorRes) {
            contentColor(ThemeUtils.getColor(this.context, colorRes));
            return this;
        }

        public Builder contentColorAttr(@AttrRes int colorAttr) {
            contentColor(ThemeUtils.resolveColor(this.context, colorAttr));
            return this;
        }
        ...
        public Builder itemsColorRes(@ColorRes int colorRes) {
            return itemsColor(ThemeUtils.getColor(this.context, colorRes));
        }

        public Builder itemsColorAttr(@AttrRes int colorAttr) {
            return itemsColor(ThemeUtils.resolveColor(this.context, colorAttr));
        }
        ...
        public Builder positiveColor(@ColorInt int color) {
            return positiveColor(ThemeUtils.getActionTextStateList(context, color));
        }

        public Builder positiveColorRes(@ColorRes int colorRes) {
            return positiveColor(ThemeUtils.getActionTextColorStateList(this.context, colorRes));
        }

        public Builder positiveColorAttr(@AttrRes int colorAttr) {
            return positiveColor(
                    ThemeUtils.resolveActionTextColorStateList(this.context, colorAttr, null));
        }
        ...
        public Builder negativeColor(@ColorInt int color) {
            return negativeColor(ThemeUtils.getActionTextStateList(context, color));
        }

        public Builder negativeColorRes(@ColorRes int colorRes) {
            return negativeColor(ThemeUtils.getActionTextColorStateList(this.context, colorRes));
        }
        ...
        public Builder neutralColor(@ColorInt int color) {
            return neutralColor(ThemeUtils.getActionTextStateList(context, color));
        }

        public Builder neutralColorRes(@ColorRes int colorRes) {
            return neutralColor(ThemeUtils.getActionTextColorStateList(this.context, colorRes));
        }
        ...
        public Builder linkColor(@ColorInt int color) {
            return linkColor(ThemeUtils.getActionTextStateList(context, color));
        }

        public Builder linkColorRes(@ColorRes int colorRes) {
            return linkColor(ThemeUtils.getActionTextColorStateList(this.context, colorRes));
        }

        public Builder linkColorAttr(@AttrRes int colorAttr) {
            return linkColor(ThemeUtils.resolveActionTextColorStateList(this.context, colorAttr, null));
        }
        ...
        public Builder widgetColorRes(@ColorRes int colorRes) {
            return widgetColor(ThemeUtils.getColor(this.context, colorRes));
        }

        public Builder widgetColorAttr(@AttrRes int colorAttr) {
            return widgetColor(ThemeUtils.resolveColor(this.context, colorAttr));
        }
        ...
        public Builder dividerColorRes(@ColorRes int colorRes) {
            return dividerColor(ThemeUtils.getColor(this.context, colorRes));
        }

        public Builder dividerColorAttr(@AttrRes int colorAttr) {
            return dividerColor(ThemeUtils.resolveColor(this.context, colorAttr));
        }
        ...
        public Builder backgroundColorRes(@ColorRes int colorRes) {
            return backgroundColor(ThemeUtils.getColor(this.context, colorRes));
        }

        public Builder backgroundColorAttr(@AttrRes int colorAttr) {
            return backgroundColor(ThemeUtils.resolveColor(this.context, colorAttr));
        }
        ...
        public Builder inputRangeRes(
            ...
            return inputRange(minLength, maxLength, ThemeUtils.getColor(context, errorColor));
        }
