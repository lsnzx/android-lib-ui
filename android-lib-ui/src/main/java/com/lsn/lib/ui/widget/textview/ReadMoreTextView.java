...
public class ReadMoreTextView extends AppCompatTextView {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        colorClickableText = typedArray.getColor(R.styleable.ReadMoreTextView_rmtv_colorClickableText, ThemeUtils.resolveColor(context, androidx.appcompat.R.attr.colorAccent));
