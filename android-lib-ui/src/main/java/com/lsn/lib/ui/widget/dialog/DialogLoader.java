...
import com.lsn.lib.ui.widget.dialog.strategy.IDialogStrategy;
import com.lsn.lib.ui.widget.dialog.strategy.InputCallback;
import com.lsn.lib.ui.widget.dialog.strategy.InputInfo;
import com.lsn.lib.ui.widget.dialog.strategy.impl.MaterialDialogStrategy;
...
public class DialogLoader implements IDialogStrategy {
     ...
     */
    @Override
    public Dialog showTipDialog(Context context, String title, String content, String submitText, DialogInterface.OnClickListener listener) {
        return mStrategy.showTipDialog(context, title, content, submitText, listener);
    }
