...
package com.lsn.lib.ui.widget.picker.wheelview;
...
import com.lsn.lib.ui.logs.UILog;
import com.lsn.lib.ui.widget.picker.wheelview.adapter.WheelAdapter;
import com.lsn.lib.ui.widget.picker.wheelview.interfaces.IPickerViewItem;
import com.lsn.lib.ui.widget.picker.wheelview.listener.LoopViewGestureListener;
import com.lsn.lib.ui.widget.picker.wheelview.listener.OnItemSelectedListener;
import com.lsn.lib.ui.widget.picker.wheelview.timer.InertiaTimerTask;
import com.lsn.lib.ui.widget.picker.wheelview.timer.MessageHandler;
import com.lsn.lib.ui.widget.picker.wheelview.timer.SmoothScrollTimerTask;
...
//                canvas.scale(1.0F, (float) Math.sin(radian));
    ...
    private String getContentText(Object item) {
        if (item == null) {
            return "";
        } else if (item instanceof IPickerViewItem) {
