...
import com.lsn.lib.ui.widget.alpha.XUIAlphaFrameLayout;
...
public class XUIFrameLayout extends XUIAlphaFrameLayout implements IXUILayout {
    ...
    public XUIFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public XUIFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
