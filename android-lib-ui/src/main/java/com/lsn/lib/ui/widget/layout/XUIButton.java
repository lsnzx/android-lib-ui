...
import com.lsn.lib.ui.widget.alpha.XUIAlphaButton;
...
public class XUIButton extends XUIAlphaButton implements IXUILayout {
    ...
    public XUIButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public XUIButton(Context context, AttributeSet attrs, int defStyleAttr) {
