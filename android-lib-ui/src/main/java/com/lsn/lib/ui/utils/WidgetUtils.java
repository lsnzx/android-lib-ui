...
import com.lsn.lib.ui.adapter.recyclerview.DividerItemDecoration;
import com.lsn.lib.ui.adapter.recyclerview.GridDividerItemDecoration;
import com.lsn.lib.ui.adapter.recyclerview.XGridLayoutManager;
import com.lsn.lib.ui.adapter.recyclerview.XLinearLayoutManager;
import com.lsn.lib.ui.widget.dialog.LoadingDialog;
import com.lsn.lib.ui.widget.dialog.MiniLoadingDialog;
import com.lsn.lib.ui.widget.progress.loading.IMessageLoader;
import com.lsn.lib.ui.widget.progress.loading.LoadingViewLayout;
...
public final class WidgetUtils {
    ...
    public static void transparentBottomSheetDialogBackground(BottomSheetDialog dialog) {
        if (dialog != null && dialog.getWindow() != null) {
            FrameLayout frameLayout = dialog.getWindow().findViewById(com.google.android.material.R.id.design_bottom_sheet);
            if (frameLayout != null) {
