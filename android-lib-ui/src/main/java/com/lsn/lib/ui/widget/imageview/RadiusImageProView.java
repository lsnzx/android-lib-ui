package com.lsn.lib.ui.widget.imageview;
...
import com.lsn.lib.ui.widget.textview.label.LabelImageView;
import com.lsn.lib.ui.widget.textview.label.LabelViewHelper;
...
public class RadiusImageProView extends AppCompatImageView {
    ...
    public RadiusImageProView(Context context) {
        this(context, null);
    }

    public RadiusImageProView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.RadiusImageProViewStyle);
    }

    public RadiusImageProView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.RadiusImageProView, defStyleAttr, 0);

        mBorderWidth = array.getDimensionPixelSize(R.styleable.RadiusImageProView_riv_pro_border_width, 0);
        mBorderColor = array.getColor(R.styleable.RadiusImageProView_riv_pro_border_color, DEFAULT_BORDER_COLOR);
        mSelectedBorderWidth = array.getDimensionPixelSize(
                R.styleable.RadiusImageProView_riv_pro_selected_border_width, mBorderWidth);
        mSelectedBorderColor = array.getColor(R.styleable.RadiusImageProView_riv_pro_selected_border_color, mBorderColor);
        mSelectedMaskColor = array.getColor(R.styleable.RadiusImageProView_riv_pro_selected_mask_color, Color.TRANSPARENT);
        ...
        mIsTouchSelectModeEnabled = array.getBoolean(R.styleable.RadiusImageProView_riv_pro_is_touch_select_mode_enabled, true);
        mIsCircle = array.getBoolean(R.styleable.RadiusImageProView_riv_pro_is_circle, false);
        if (!mIsCircle) {
            mIsOval = array.getBoolean(R.styleable.RadiusImageProView_riv_pro_is_oval, false);
        }
        if (!mIsOval) {
            mCornerRadius = array.getDimensionPixelSize(R.styleable.RadiusImageProView_riv_pro_corner_radius, 0);
        }
